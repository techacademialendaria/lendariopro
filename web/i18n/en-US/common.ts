const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Lab[IA] account',
    langGeniusAccountTip: 'Your Lab[IA] account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Lab[IA] to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Lab[IA] allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Lab[IA]\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Lab[IA] {{version}} is now available.',
    latestAvailable: 'Lab[IA] {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
