const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cont Lab[IA]',
    langGeniusAccountTip: 'Contul Lab[IA] și datele de utilizator asociate.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în Lab[IA] pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de Lab[IA] vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile Lab[IA].',
  ...
  about: {
    ...
    nowAvailable: 'Lab[IA] {{version}} este acum disponibil.',
    latestAvailable: 'Lab[IA] {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
