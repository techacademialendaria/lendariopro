const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Lab[IA]-Konto',
    langGeniusAccountTip: 'Ihr Lab[IA]-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei Lab[IA] anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von Lab[IA] ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  about: {
    ...
    nowAvailable: 'Lab[IA] {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Lab[IA] {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
