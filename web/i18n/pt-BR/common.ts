const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta Lab[IA]',
    langGeniusAccountTip: 'Sua conta Lab[IA] e dados de usuário associados.',
  ...
  members: {
    ...
    invitationSent: 'Convite gerado',
    invitationSentTip: 'Copie o link e compartilhe com o usuário para acessar os dados da sua equipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela Lab[IA] permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.',
      callTimes: 'Chamadas',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da Lab[IA].',
  ...
  about: {
    ...
    nowAvailable: 'Lab[IA] {{version}} já está disponível.',
    latestAvailable: 'Lab[IA] {{version}} é a última versão disponível.',
  },
  appMenus: {
