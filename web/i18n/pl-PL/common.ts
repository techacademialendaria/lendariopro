const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Lab[IA]',
    langGeniusAccountTip: 'Twoje konto Lab[IA] i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Lab[IA], aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Lab[IA] pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Lab[IA].',
  ...
  about: {
    ...
    nowAvailable: 'Lab[IA] {{version}} jest teraz dostępny.',
    latestAvailable: 'Lab[IA] {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
